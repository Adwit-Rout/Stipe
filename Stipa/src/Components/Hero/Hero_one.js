      ...
      <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
          ...
          <div class="flex justify-center">
            <div className = 'flex justify-center items-center h-100vh'>
              ...
              >
                <div class="flex justify-center flex-col">
                  ...
                  <div className='flex flex-row'>
                    ...
                    <input type="name" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-100% p-2.5 px-5 mx-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Sam" required />
                  </div>
              ...
              <button class="ml-4 inline-flex text-gray-700 border-0 py-2 px-3 focus:outline-none  hover:text-white rounded text-xl font-bold" onClick={() => setIsOpen(true)}>Watch Video <span className='text-2xl'>▶️</span></button>
              <Modal
                isOpen={modalIsOpen}
                onRequestClose={() => setIsOpen(false)}
                overlayClassName={{
              ...
              >
                <div class="flex justify-center ">
                <video width="60%" height="60%" className='flex justify-center items-center' controls>
                  <source src={video} />
                </video>
                 </div>
              </Modal>
