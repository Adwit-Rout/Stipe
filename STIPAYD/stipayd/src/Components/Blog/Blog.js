          ...
          >
            ...
            >
              ...
              >
                ...
                <p className='my-2'>
                Having FOMO of not being able to invest in that trending stock or your favorite startup IPO? With STIPayD, you can invest in all that and watch your money grow.
                </p>
                <button
                  class="bg-yellow-500 px-6 py-2 font-semibold text-white rounded-full absolute -bottom-20 delay-500 duration-1000 group-hover:bottom-20 scale-0 group-hover:scale-125"
                >
          ...
          >
            ...
            >
              ...
              >
                ...
                <p className='my-2'>
                Plan and save funds for your short and long term needs. Set goals and start investing to complete them early through SIP's
                </p>
                <button
                  class="bg-yellow-500 px-6 py-2 font-semibold text-white rounded-full absolute -bottom-20 delay-500 duration-1000 group-hover:bottom-20 scale-0 group-hover:scale-125"
                >
